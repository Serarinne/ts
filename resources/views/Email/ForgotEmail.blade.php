...
<body>
    <section style="max-width:48rem;padding:2rem;margin-left:auto;margin-right:auto;border-radius:.5rem;box-shadow:0 4px 6px -1px rgb(0 0 0 / .1), 0 2px 4px -1px rgb(0 0 0 / .06)">
        <main style="margin-top:.5rem">
            ...
            <a href="https://{{ $ServerDomain }}/reset-password?token={{ $resetToken }}" target="_blank" style="margin-top:1rem;margin-bottom:1.5rem;line-height:1.75rem;color:#3b82f6;text-decoration:underline">
                https://{{ $ServerDomain }}/reset-password?token={{ $resetToken }}
            </a>
        ...
        <footer style="margin-top:2rem;padding-top:1rem;border-top:1px solid #e5e7eb">
            <p style="font-size:.875rem;color:#6b7280">
                You received this email because we received a password reset request. If you did not do this, please contact us.
            </p>
