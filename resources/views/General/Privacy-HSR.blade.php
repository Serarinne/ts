...
<head>
	...
	<title>Privacy Policy HSR Wallpapers 4K</title>
...
<body>
	...
	<section name="PostData" class="mx-3 my-3">
		<div class="lg:mx-0 px-5 py-5">
			<h1 class="text-3xl text-center font-bold tracking-tight text-gray-900 sm:text-4xl">Privacy Policy HSR Wallpapers 4K</h1>
		</div>
